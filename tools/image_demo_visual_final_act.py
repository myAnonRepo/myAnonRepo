...
def main():
    ...
    for i in os.listdir(images_dir):
        ...
        for feature in x_backone:
            ...
            cv2.imwrite(fm_save_path + '/stage_' + str(feature_index) + '_heatmap.jpg', heatmap_image)
            result = cv2.addWeighted(image, 0.8, heatmap_image, 0.3, 0)
            cv2.imwrite(fm_save_path + '/stage_' + str(feature_index) + '_result.jpg', result)
        ...
        for feature in x_fpn:
            ...
            cv2.imwrite(fm_save_path+ '/P' + str(feature_index) + '_heatmap.jpg', heatmap_image)  # 生成图像
            result = cv2.addWeighted(image, 0.8, heatmap_image, 0.4, 0)
            cv2.imwrite(fm_save_path + '/P' + str(feature_index) + '_result.jpg', result)
