...
def main():
    ...
    config = '/home/maer/Workspace/mmdetection/configs/carafe/faster_rcnn_r50_fpn_carafe_1x_coco.py'
    checkpoint = '/home/maer/Workspace/mmdetection/work_dirs/faster_rcnn_r50_fpn_1x_coco_fpn_carafe/latest.pth'
